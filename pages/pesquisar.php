...
$buscar = Listar::buscar($_GET['pesquisa']);
...
<div id="conteudo">
  <!-- <div class="container"> -->
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="home.php">Destaque</a>
            </li>
            <li class="nav-item">
    ...
    <section>
      <h2 style="padding: 20px; text-align: center;color:white;">Você pesquisou: <?= $_GET['pesquisa']  ?></h2>
      <div class="carousel-movie" id="livros">
        <div class="owl-carousel pesquisa owl-theme" >

          <?php
          if(count($buscar) > 0){

         
          foreach ($buscar as $produto) {

          ?>

            <div class="item">
              <a href="produto.php?id=<?= $produto->id ?>">
                <img width="300px" height="400px" src="../img/img/<?php echo $produto->img ?>">
              </a>
            </div>
         <?php } ?>
        </div>
  ...
  <!-- Footer -->
  <footer class="bg-dark text-center text-white" id="contato"style="margin-top: 220px;">
    <!-- Grid container -->
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2021 Copyright:
      <a class="text-white" target="_blank" href="https://github.com/TeamLAGdev/Biblioteca2.0-pi">TeamLagdev</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
