...
$acao = Listar::ListaAcao();
$romance = Listar::ListaRomance();
$aventura = Listar::ListaAventura();
// var_dump($recentes);
 ...
 <div class="container">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Biblioteca ETE</a>
  ...
  <section>
    ...
    <div class="carousel-movie" id="destaque">
      ...
      <div class="owl-carousel owl-theme">
        ...
        ?>
          <div class="item">
            <a href="produto.php?id=<?= $produto->id ?>"><img width="300px" height="400px" src="../img/img/<?php echo $produto->img ?>" alt="" srcset=""></a>
          </div>
        <?php  } ?>
      </div>
    </div>
    <div class="carousel-movie">
        <h3 style="color:white;">Ação</h3>
        <div class="owl-carousel owl-theme" id="livros">
        <?php
            foreach ($acao as $produto) {
            ?>
              <div class="item">
                <a href="produto.php?id=<?= $produto->id ?>"><img width="300px" height="400px" src="../img/img/<?php echo $produto->img ?>" alt="" srcset=""></a>
              </div>
      ...
      <div class="carousel-movie">
        <h3 style="color:white;">Aventura</h3>
        <div class="owl-carousel owl-theme" id="livros">
        <?php
            foreach ($aventura as $produto) {
            ?>
              <div class="item">
                <a href="produto.php?id=<?= $produto->id ?>"><img width="300px" height="400px" src="../img/img/<?php echo $produto->img ?>" alt="" srcset=""></a>
              </div>
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top" id="contato">
    <div class="row">
      ...
      <div class="col-6 col-md">
        <h5 style="color: white;">Desenvolvedores</h5>
        <ul class="list-unstyled text-small">
         <li class="mb-1"><a class="link-secondary text-decoration-none" target="_blank" href="https://github.com/TeamLAGdev">Team LAG</a></li>
        </ul>
      </div>
      <div class="col-6 col-md">
